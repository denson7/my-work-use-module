 ...
 * Time: 10:13
 */
class Inup_SocialConnect_Block_Register extends Mage_Core_Block_Template
{
    ...
    protected function _construct()
    {
        ...
        Mage::register('inup_socialconnect_button_text', $this->__('Register'), true);

        $this->setTemplate('inup/socialconnect/register.phtml');
    }
    ...
    {
        return (bool)$this->clientWeibo->isEnabled();
    }
