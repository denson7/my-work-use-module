 ...
 */
class J2t_Rewardpoints_Block_Adminhtml_Catalogpointrules_Edit_Tab_Labels extends Mage_Adminhtml_Block_Widget
{

    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('rewardpoints/labels_catalog.phtml');
    }
    ...
    {
        $current_rule = Mage::registry('catalogpointrules_data');
        $return_value = array();
