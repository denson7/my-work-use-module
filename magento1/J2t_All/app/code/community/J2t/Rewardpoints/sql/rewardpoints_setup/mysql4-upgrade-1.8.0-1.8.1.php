...
$attributeInfo = Mage::getResourceModel('eav/entity_attribute_collection')
                        ->setCodeFilter('reward_points_limit_usage')
                        ->getFirstItem();
...
if(!$attributeInfo->getAttributeId() && $attributeGroup->getAttributeSetId()){
    ...
    $setup->addAttribute('catalog_product', 'reward_points_limit_usage', array(
        'group'                         => 'J2T Reward Points',
        'input'                         => 'text',
        'type'                          => 'text',
        'label'                         => 'Point usage limit',
        ...
        'note'                          => 'Set maximum price value to be discounted on point usage for this product (use 0 or empty for no limit).',
    ));
