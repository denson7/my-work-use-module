 ...
 */
namespace Silk\July\Controller\Index;
...
class Post extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $pathurl = $this->_storeManager->getStore()->getBaseUrl(\Magento\Framework\UrlInterface::URL_TYPE_MEDIA) . 'july/';
        ...
        $model = $this->_objectManager->create('Silk\July\Model\Employee');
        ...
        /*if(isset($_FILES['e_profile_picture']))
        {
            ...
            move_uploaded_file($file_tmp, $mediapath . '/july/' . $file_name);
